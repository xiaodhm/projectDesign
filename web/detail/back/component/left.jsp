	    ...
	    <li class="level1">
            ...
            <ul class="MenuLevel2">
            	<li class="level2 level2Style">
                    <a target="right" href="../content/votelist.jsp">查看投票情况</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="../content/itemlist.jsp" methods="post" >主题管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="../content/slctorlist.jsp">选项管理</a>
				</li>
            </ul>
        </li>
    </ul>
